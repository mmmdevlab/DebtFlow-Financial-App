...
import { Eye, CreditCard, TrendDown } from "@phosphor-icons/react";
...
const AuthPage = () => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row items-center justify-center p-6 gap-10">
      ...
      <div className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm text-gray-800 max-w-md space-y-6">
        ...
        <div className="space-y-4">
          {benefits.map((b) => (
            <div key={b.title} className="flex items-start gap-4">
              <div className="bg-green-500 text-white p-2 rounded-xl flex-shrink-0">
                {b.icon}
              </div>
              <div>
