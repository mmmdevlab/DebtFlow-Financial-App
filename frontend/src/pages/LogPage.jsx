...
// usestate to hide the logpayment and all payment history
// we have to direct the user to this page to make payments when they click on a debt from the list of debts.
